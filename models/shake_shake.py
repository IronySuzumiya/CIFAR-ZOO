...
def shake_resnet26_2x32d(config):
    return ShakeResNet(depth=26, base_width=32, num_classes=config.num_classes)


def shake_resnet26_2x64d(config):
    return ShakeResNet(depth=26, base_width=64, num_classes=config.num_classes)
